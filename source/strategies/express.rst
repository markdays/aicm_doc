...
=====  ==============   ========================================================================================= 
 ...
 (3)    赋值              :=, +=, -=, *=, /=, %=
 (4)    等式&不等式       =, ==, <>, !=, <, <=, >, >=
 (5)    逻辑操作          and, mand, mor, nand, nor, not, or, shl, shr, xnor, xor, true, false.
 (6)    函数              abs, avg, ceil, clamp, equal, erf, erfc,  exp, expm1, floor, frac,  log, log10, log1p,  log2, logn,  max,  min,  mul,  ncdf,  nequal,  root, round, roundn, sgn, sqrt, sum, swap, trunc
 (7)    三角函数          acos, acosh, asin, asinh, atan, atanh,  atan2, cos,  cosh, cot,  csc, sec,  sin, sinc,  sinh, tan, tanh, hypot, rad2deg, deg2grad,  deg2rad, grad2deg.
